...
import { PlaylistI, PlaylistItemsI, PlaylistTrackI } from '../models/playlist.model';
...
export class PlaylistsService {
  ...
  getCurrentUserPlaylists(): Observable<PlaylistI[]> {
    ...
    return this.http.get<List<PlaylistI>>(url)
      .pipe(
  ...
  getPlaylistTracks(playlistId:string): Observable<PlaylistItemsI<PlaylistTrackI>> {
